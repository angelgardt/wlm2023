...
Визуализируйте центральную предельную теорему.

:::{.callout-note}
#### Центральная предельная теорема

Центральная предельная теорема утверждает, что распрделение выборочных средних с ростом числа выборок стремиться к нормальному распределению.
:::
...
На лекции мы математически вывели, что среднее арифметическое является насмещенной оценкой математического ожидания генеральной совокупности. Проверьте это на симуляции.
...
Проверьте на симуляциях, что оценка дисперсии $\hat \sigma^2 = \frac{\sum_{i=1}^n (x_i - \bar x)}{n}$ является смещенной, а оценка $\hat \sigma^2 = s^2 = \frac{\sum_{i=1}^n (x_i - \bar x)}{n-1}$ является несмещенной.
...
покажите симуляционно, что среднее как оценка математического ожидания является состоятельной
...
Покажите симуляционно, что оценки дисперсии является состоятельной
...
Повторите симуляции для ДИ и captire percantage на sim2
...
Существует также и одновыборочный t-тест:

$$
t = \frac{\bar X - \mu}{s / \sqrt{n}} = \frac{\bar X - \mu}{\text{se}_X}
$$

Одновыборочный t-тест на первых выборка sim1 и sim3.
...
вероятность ложноположительного вывода при заданном уровне значимости, если верна H0
...
вероятность получить значимые различия, если верна H1
...
распределение п-валью при H0 и H1
...
зависимость p-value от объема выборки
