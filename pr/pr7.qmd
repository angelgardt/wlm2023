...
По [ссылке](https://github.com/angelgardt/wlm2023/raw/master/data/hw6/dice.RData) расположен файл `.RData` с симуляцией двух четырехгранных игральных кубиков `dice1` и `dice2`. Один из них является честным, другой --- нечестным.
...
Выбранный вами в предыдущем задании респондент действительно оказался профессиональным. Какова вероятность, что он был рекрутирован первым агенством? вторым агенством?
...
Сгенерируйте 12 выборок по 60 наблюдений из нормального распределения $\mathacal N(3, 4)$. Вызуализируйте распределение переменной в каждой из выборок и сравните их друг с другом.
