...
* Проверьте, что вы разархивировали скачанных архив в папку проекта
...
a. Выведите первые 10 строк датафрейма.
b. Выведите 5 последних строк датафрейма.
...
Превратите директорию проекта курса в git-репозиторий (локальный или глобальный).
