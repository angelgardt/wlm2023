...
* Разрешение (размер) экрана: 1920×1080
* Зазор между областями колебания стимулов: 10
* Количество стимулов по ширине экрана: 7
* Количество стимулов по высоте экрана: 3
* Горизонтальный отступ от края экрана: 100
* Вертикальный отступ от края экрана: 100
* Горизонтальный размер стимула: 100
* Вертикальный размер стимула: 100
* Количество проб, для которых надо сгенерировать координаты: 30
