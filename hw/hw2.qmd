...
Автопроверка настроена на результаты, получаемы при значении зерна датчика случайных чисел `set.seed(420)`.
...
* При использовании `matrix()` необходимо указать число столбцов, которе равно числу столбцов входной матрицы.
