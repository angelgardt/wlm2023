...
Честный, нечестный, невозможный восьмигранный кубик

:::

```{r hw6-dice}
dice1 <- function(n) {
  sample(1:8, n, replace = TRUE, prob = 1/8)
}
dice2 <- function(n) {
  sample(1:8, n, replace = TRUE, prob = c(1/4, rep(1/12, 6), 1/4))
}
dice3 <- function(n) {
  sample(1:8, n, replace = TRUE, prob = c(1/4, rep(1/5, 6), 1/8))
}
